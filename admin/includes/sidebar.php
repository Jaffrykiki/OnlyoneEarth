...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-gradient-info" id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="navbar-brand m-0" href="index.php">
      ...
      <h5>สวัสดี:<?= $_SESSION['auth_user']['name']; ?>
        <?php if (isset($_SESSION['auth_user']['img']) && !empty($_SESSION['auth_user']['img'])) : ?>
  ...
  <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link text-white <?= $page == "withdraw.php" ? 'bg-gradient-warning' : ''; ?>" href="withdraw.php">
          <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            <i class="material-icons opacity-10">report</i>
          </div>
          <span class="nav-link-text ms-1">รายการถอนเงิน</span>
        </a>
      </li>
