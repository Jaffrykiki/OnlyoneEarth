...
// เพิ่มเงื่อนไขเช็คการเข้าสู่ระบบ
if (isset($_SESSION['auth'])) {
    // ถ้ามีเซสชัน auth แสดงว่าผู้ใช้เข้าสู่ระบบอยู่
    // กำหนดข้อความและเปลี่ยนเส้นทางไปที่หน้าอื่นหรือออกจากระบบ
    $_SESSION['message'] = "กรุณาออกจากระบบก่อนทำการสมัครผู้ขาย";
    header('Location: index.php');
    exit();
}
